...
#### 🖼️ Image Processing (AFOLIE/image)
| Node | Description |
|------|-------------|
...
| Node | Description |
|------|-------------|
| **Load Image 🖼️** | Drag & drop image upload, preserves PNG transparency as 4-channel RGBA output |
...
| **Transparent Preview 👁️** | Preview images with transparent background (RGBA PNG) |
| **Transparent Save 💾** | Save images as transparent PNG with ComfyUI official naming |

#### ✏️ Text Nodes (AFOLIE/text)
| Node | Description |
|------|-------------|
...
| 节点 | 说明 |
|------|------|
| **加载图片 🖼️** | 支持拖拽/粘贴上传图片，PNG 透明通道保留在 4 通道 RGBA 图像输出中 |
